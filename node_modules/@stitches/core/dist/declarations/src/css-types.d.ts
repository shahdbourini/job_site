...
export declare type BorderProperty<TLength> = Globals | LineWidth<TLength> | LineStyle | Color | (string & {}) | [LineWidth<TLength>, LineStyle, Color];
...
export declare type FlexProperty<TLength> = Globals | TLength | 'auto' | 'available' | 'content' | 'fit-content' | 'max-content' | 'min-content' | 'none' | (string & {}) | number | [number, number | (string & {})] | [number, number, string & {}];
...
export declare type GridTemplateColumnsProperty<TLength> = Globals | TrackBreadth<TLength> | 'none' | 'subgrid' | (string & {});
export declare type GridTemplateRowsProperty<TLength> = Globals | TrackBreadth<TLength> | 'none' | 'subgrid' | (string & {});
export declare type HangingPunctuationProperty = Globals | 'allow-end' | 'first' | 'force-end' | 'last' | 'none' | (string & {});
export declare type HeightProperty<TLength> = Globals | TLength | '-moz-max-content' | '-moz-min-content' | '-webkit-fit-content' | 'auto' | 'available' | 'fit-content' | 'max-content' | 'min-content' | (string & {});
...
export declare type LineBreakProperty = Globals | 'anywhere' | 'auto' | 'loose' | 'normal' | 'strict';
...
export declare type MarginProperty<TLength> = Globals | TLength | 'auto' | (string & {}) | [Globals | TLength | 'auto' | (string & {}), Globals | TLength | 'auto' | (string & {})] | [Globals | TLength | 'auto' | (string & {}), Globals | TLength | 'auto' | (string & {}), Globals | TLength | 'auto' | (string & {})] | [Globals | TLength | 'auto' | (string & {}), Globals | TLength | 'auto' | (string & {}), Globals | TLength | 'auto' | (string & {}), Globals | TLength | 'auto' | (string & {})];
...
export declare type MaskOriginProperty = Globals | Box | 'margin-box' | (string & {});
...
export declare type MaxHeightProperty<TLength> = Globals | TLength | '-moz-fit-content' | '-moz-max-content' | '-moz-min-content' | '-webkit-fit-content' | '-webkit-max-content' | '-webkit-min-content' | 'fill-available' | 'fit-content' | 'intrinsic' | 'max-content' | 'min-content' | 'none' | (string & {});
...
export declare type MinHeightProperty<TLength> = Globals | TLength | '-moz-fit-content' | '-moz-max-content' | '-moz-min-content' | '-webkit-fit-content' | '-webkit-max-content' | '-webkit-min-content' | 'auto' | 'fill-available' | 'fit-content' | 'intrinsic' | 'max-content' | 'min-content' | (string & {});
export declare type MinInlineSizeProperty<TLength> = Globals | TLength | '-moz-fit-content' | '-moz-max-content' | '-moz-min-content' | '-webkit-fill-available' | 'auto' | 'fill-available' | 'fit-content' | 'max-content' | 'min-content' | (string & {});
...
export declare type OpacityProperty = Globals | (string & {}) | number;
...
export declare type PaddingProperty<TLength> = Globals | TLength | (string & {}) | [Globals | TLength | (string & {}), Globals | TLength | (string & {})] | [Globals | TLength | (string & {}), Globals | TLength | (string & {}), Globals | TLength | (string & {})] | [Globals | TLength | (string & {}), Globals | TLength | (string & {}), Globals | TLength | (string & {}), Globals | TLength | (string & {})];
...
export declare type QuotesProperty = Globals | 'auto' | 'none' | (string & {});
...
export declare type ShapeImageThresholdProperty = Globals | (string & {}) | number;
...
export declare type TextDecorationProperty<TLength> = Globals | Color | TLength | 'auto' | 'blink' | 'dashed' | 'dotted' | 'double' | 'from-font' | 'grammar-error' | 'line-through' | 'none' | 'overline' | 'solid' | 'spelling-error' | 'underline' | 'wavy' | (string & {});
export declare type TextDecorationColorProperty = Globals | Color;
export declare type TextDecorationLineProperty = Globals | 'blink' | 'grammar-error' | 'line-through' | 'none' | 'overline' | 'spelling-error' | 'underline' | (string & {});
...
export declare type TextDecorationThicknessProperty<TLength> = Globals | TLength | 'auto' | 'from-font';
...
export declare type TextUnderlineOffsetProperty<TLength> = Globals | TLength | 'auto' | 'from-font';
...
export declare type WhiteSpaceProperty = Globals | '-moz-pre-wrap' | 'break-spaces' | 'normal' | 'nowrap' | 'pre' | 'pre-line' | 'pre-wrap';
...
export declare type ZIndexProperty = Globals | 'auto' | number | string;
...
export declare type Color = NamedColor | DeprecatedSystemColor | 'currentcolor' | (string & {});
...
export declare type LineWidth<TLength> = TLength | 'medium' | 'thick' | 'thin';
